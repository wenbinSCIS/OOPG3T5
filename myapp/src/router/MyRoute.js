...
import GenerateSection from "../components/Imtesting/SectionGeneration";
import VendorAssessmentForm1 from "../components/Imtesting/VendorAssessmentForm";
  ...
  return (
    <>
      <Routes>
        ...
        <Route exact path="/test" element={<VendorAssessmentForm1/>}/> 
